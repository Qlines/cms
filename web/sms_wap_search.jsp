...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            window.onload=function(){
                var frm = document.forms["smsWapSearchFrm"];

                if(NiftyCheck())RoundedTop("div#smsWapSearchContent","#C0CDF2","#FFF");
                if(NiftyCheck())RoundedBottom("div#searchBar","#FFF","<%=bar_color%>");
                if(NiftyCheck())Rounded("div#searchBox","<%=bar_color%>","#FFF");

                smsWap_search_onblur();


                frm.submit();
            }

            function smsWap_search_onsubmit() {
                var frm = document.forms["smsWapSearchFrm"];
            ...
            function smsWap_search_onfocus() {
                var frm = document.forms["smsWapSearchFrm"];
                if (frm.search.value == "Search...") {
                    frm.search.value = "";
                }
    ...
    <body class="content" style="padding:20px">
        <div id="smsWapSearchContent" style="width:100%; height:500px; background-color:#FFF;">
            <form target="resultFrame" id="smsWapSearchFrm" method="post" action="SmsWapListServlet" onsubmit="return smsWap_search_onsubmit();">
                                ...
                                <div id="searchBox" class="transparent" style="background-color:#fff; width: 280px;">
                                    <div class="transparent" style="padding: 0 10px 0 10px;">
                                        <input type="text" name="search" id="search" style="width:200px;"
                                               onblur="smsWap_search_onblur()" onfocus="smsWap_search_onfocus()">
