<%-- 
    Document   : report_subscription_summary_monthly
...
<html>
    ...
    <body class="content">
        <div id="reportSubscriptionSummaryContent" style="width:98%; height:450px; background-color:#FFF;">
            <form target="resultFrame" id="reportSubscriptionSummaryFrm" method="post" action="SubscriptionSummaryMonthlyReportServlet" onsubmit="return report_subscription_Summary_onsubmit();">
