...
<html>
    ...
    <body class="content">
        <div id="reportSmsdownloadSummaryContent" style="width:98%; height:450px; background-color:#FFF;">
            <form target="resultFrame" id="reportSmsdownloadSummaryFrm" method="post" action="SubscriptionSummaryDailyReportServlet" onsubmit="return report_smsdownload_Summary_onsubmit();">
