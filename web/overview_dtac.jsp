            ...
            <div id="content2" style="width:90%; text-align:center; background-color:#FFF; margin:10px 0 0 10px;">
                <table width="90%" class="table4" style="margin:0; padding:10px;">
                    <tr>
                        ...
                        <td style="text-align: right; vertical-align: bottom"><%= overviewBean.getLastTimeSent(1)%>
                        </td></tr>
                    <tr>
                        <th width="50%">Maximum speed :</th>
                        <td style="text-align: right; vertical-align: bottom"><%= overviewBean.getMaxSpeed(1)%> msg/sec
                        </td></tr>
                    <tr>
                        <th width="50%">Undeliver (New/Queue) :</th>
                        <td style="text-align: right; vertical-align: bottom"><%= overviewBean.getNewTx(1)%>/<%= overviewBean.getSendingTx(1)%> msg
                        </td></tr>
                    <tr>
                        <th width="50%">Total sent message :</th>
                        <td style="text-align: right; vertical-align: bottom"><%= overviewBean.getSuccessTx(1)%> msg
                        </td></tr>
                    <tr>
                        <th width="50%">Failed sent:</th>
                        <td style="text-align: right; vertical-align: bottom"><%= overviewBean.getFailTx(1)%> msg
                        </td></tr>
                </table>
            </div>
        </div>
