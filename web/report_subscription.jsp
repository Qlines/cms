<%-- 
    Document   : report
    Created on : 5 ก.พ. 2553, 14:44:40
    Author     : developer
--%>
...
<%
    ...
    String [][]menu = {
        {"daily",       "Daily Report",         "report_subscription_daily.jsp"},
        {"daily_sum",   "Daily Summary",        "report_subscription_summary_daily.jsp"},
        {"monthly_sum", "Monthly",              "report_subscription_summary_monthly.jsp"}
        };
