...
<html>
    <head>
        ...
        <%
            ...
            int srvc_type = SERVICE_TYPE.MMS.getId() | SERVICE_TYPE.SUBSCRIPTION.getId();
        ...
        <script type="text/javascript">
            ...
            function updateServiceOptions(oper_id, obj) {
                var frm = document.pushMessageMmsFrm;
            ...
            function getMmsId() {
                var id= window.showModalDialog("MmsListServlet?cmd=select&page=1&orderby=&keyword=&rows=5","", "dialogWidth:640px;dialogHeight:670px");
            ...
            function showMmsDetail(id) {
                var obj = getElement('mmsMessageDiv');
                
                obj.style.display='block';
                getElement('mmsMessageSelectDiv').style.display = 'none';
                
                obj.innerHTML = ajaxPost("MessageMmsDetail?id=" + id);
            }

            function _onsubmit() {
                var frm = document.pushMessageMmsFrm;
                if (frm.ctnt_id.value.trim().length == 0) {
                    alert('Please select the mms content!');
                    return false;
                }
    ...
    <body class="content">
        <div id="pushMessageSmsMms" style="width:100%;">
            <form target="ctFrame" name="pushMessageMmsFrm" method="post" action="pushMessageSmsServlet"
                ...
                <input type="hidden" name="type" value="<%=ACTION_TYPE.MMS.toString()%>" >
                ...
                <div id="content" style="width:75%;padding-top: 10px;">
                    <div id="content2" style="width:90%; text-align:center; background-color:#FFF; margin:10px 0 0 10px">
                        <table align="center" class="table4" style="width:90%; margin-top:0px; padding:0;">
                            ...
                            <tr class="reset">
                                <th>MMS Content :</th>
                                <td onclick="javascript:getMmsId();" title="Click to change MMS Content">
                                    <input type="hidden" name="ctnt_id" id="ctnt_id" value="<%=_content_id%>">
                                    <div id="mmsMessageSelectDiv"<%=_content_id>0 ? " style='display:none'" : ""%>>
                                        <a href="javascript:" class="txtxt">choose MMS</a>
                                    </div>
                                    <div id="mmsMessageDiv"<%=_content_id==0 ? " style='display:none'" : ""%>>
                                    </div>
                                </td>
                            </tr>
                            <tr>
