...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            window.onload=function(){
                var frm = document.forms["linkSearchFrm"];

                if(NiftyCheck())RoundedTop("div#linkSearchContent","#C0CDF2","#FFF");
    ...
    <body class="content">
        <div id="linkSearchContent" style="width:100%; height:500px; background-color:#FFF;">
            <form target="resultFrame" id="linkSearchFrm" method="post" action="LinkListServlet" onsubmit="return link_search_onsubmit();">
                <input type="hidden" name="cmd" value="refresh">
                <input type="hidden" name="page" value="1">
                <input type="hidden" name="orderby" value="register">
                <div style="padding: 5px 10px 5px 10px;">
                    <h2 class="link">Link Config</h2><hr>
