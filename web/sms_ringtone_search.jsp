...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            window.onload=function(){
                var frm = document.forms["smsRingtoneSearchFrm"];

                if(NiftyCheck())RoundedTop("div#smsRingtoneSearchContent","#C0CDF2","#FFF");
                if(NiftyCheck())RoundedBottom("div#searchBar","#FFF","<%=bar_color%>");
                if(NiftyCheck())Rounded("div#searchBox","<%=bar_color%>","#FFF");

                smsRingtone_search_onblur();

                frm.submit();
            }

            function smsRingtone_search_onsubmit() {
                var frm = document.forms["smsRingtoneSearchFrm"];
            ...
            function smsRingtone_search_onblur() {
                var frm = document.forms["smsRingtoneSearchFrm"];
            ...
            function smsRingtone_search_onfocus() {
                var frm = document.forms["smsRingtoneSearchFrm"];
                if (frm.search.value == "Search...") {
                    frm.search.value = "";
                }
    ...
    <body class="content" style="padding:20px">
        <div id="smsRingtoneSearchContent" style="width:100%; height:500px; background-color:#FFF;">
            <form target="resultFrame" id="smsRingtoneSearchFrm" method="post" action="SmsRingtoneListServlet" onsubmit="return smsRingtone_search_onsubmit();">
                ...
                <div style="padding: 5px 10px 5px 10px;">
                    <h2 class="smsringtone">SMS Ringtone</h2>
                                ...
                                <div id="searchBox" class="transparent" style="background-color:#fff; width: 280px;">
                                    <div class="transparent" style="padding: 0 10px 0 10px;">
                                        <input type="text" name="search" id="search" style="width:200px;"
                                               onblur="smsRingtone_search_onblur()" onfocus="smsRingtone_search_onfocus()">
