...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            window.onload=function(){
                var frm = document.forms["smsTextSearchFrm"];

                if(NiftyCheck())RoundedTop("div#smsTextSearchContent","#C0CDF2","#FFF");
                if(NiftyCheck())RoundedBottom("div#searchBar","#FFF","<%=bar_color%>");
                if(NiftyCheck())Rounded("div#searchBox","<%=bar_color%>","#FFF");

                smsText_search_onblur();


                frm.submit();
            }

            function smsText_search_onsubmit() {
                var frm = document.forms["smsTextSearchFrm"];
            ...
            function smsText_search_onblur() {
                var frm = document.forms["smsTextSearchFrm"];
            ...
            function smsText_search_onfocus() {
                var frm = document.forms["smsTextSearchFrm"];
                if (frm.search.value == "Search...") {
                    frm.search.value = "";
                }
    ...
    <body class="content" style="padding:20px">
        <div id="smsTextSearchContent" style="width:100%; height:500px; background-color:#FFF;">
            <form target="resultFrame" id="smsTextSearchFrm" method="post" action="SmsTextListServlet" onsubmit="return smsText_search_onsubmit();">
                                ...
                                <div id="searchBox" class="transparent" style="background-color:#fff; width: 280px;">
                                    <div class="transparent" style="padding: 0 10px 0 10px;">
                                        <input type="text" name="search" id="search" style="width:200px;"
                                               onblur="smsText_search_onblur()" onfocus="smsText_search_onfocus()">
