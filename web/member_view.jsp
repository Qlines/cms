...
<jsp:useBean id="memberBean" scope="application" class="smsgateway.webadmin.bean.MemberBean" />
...
<html>
    <head>
        ...
        <script type="text/javascript">
            <%
                        ...
                        // get parameters
                        String[] msisdn = request.getParameter("msisdn").split(";");
                        String msisdn_tmp = request.getParameter("msisdn");
                        ...
                        String memberList = memberBean.findMember(msisdn, srvcid, operid, sort, (pg - 1) * records, records, user); // get all records
    ...
    <body class="content">
        <div id="memberViewContent" style="width:100%;padding:0;">
            <div style="padding: 0; margin: 0;width:100%;background-color: #FFF;">
                <div id="data" style=" overflow: auto ;padding: 0;width:100%;"></div>
            </div>
            ...
            <div id="popupmenu"
                ...
                <div id="popupmenubg" style="height:60px; width:100%; text-align:center; background-color:transparent; position:relative; padding:0px;">
