...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function updateServiceOptions(oper_id, obj) {
                var frm = document.pushMessageSmsPictureFrm;
            ...
            function getPictureId() {
                var tmp= window.showModalDialog("SmsPictureListServlet?cmd=select&page=1&rows=20","", "dialogWidth:640px;dialogHeight:670px");
                var pic = tmp.split('|');
                
                var display = getElement('pictureMessage');
                display.src = pic[1];
                
                getElement('pictureMessageDiv').style.display='block';
                getElement('pictureMessageSelectDiv').style.display = 'none';
            ...
            function _onsubmit() {
                ...
                if (frm.ctnt_id.value.trim().length == 0) {
                    alert('Please select the picture message!');
                    return false;
                }
    ...
    <body class="content">
        <div id="pushMessageSmsPicture" style="width:100%;">
            <form target="ctFrame" name="pushMessageSmsPictureFrm" method="post" action="pushMessageSmsServlet"
                ...
                <div id="content_header" style="width:75%; background-color:#FFF">
                    <h2 class="smslogo">Picture Message</h2>
                </div>
                <div id="content" style="width:75%;padding-top: 10px;">
                    <div id="content2" style="width:90%; text-align:center; background-color:#FFF; margin:10px 0 0 10px">
                        <table align="center" class="table4" style="width:90%; margin-top:0px; padding:0;">
                            ...
                            <tr>
                                <th>Picture Message :</th>
                                <td onclick="javascript:getPictureId();" title="Click to change picture">
                                    <input type="hidden" name="ctnt_id" id="ctnt_id" value="<%=_content_id%>">
                                    <div id="pictureMessageSelectDiv"<%=_content_id>0 ? " style='display:none'" : ""%>>
                                        <a href="javascript:" class="txtxt">choose picture</a>
                                    </div>
                                    <div id="pictureMessageDiv"<%=_content_id==0 ? " style='display:none'" : ""%>>
                                        <img id="pictureMessage" border="0"<%=_content_id>0 ? " src='header?file=" + _img_src + "'" : ""%>>
                                    </div>
                                </td>
                            </tr>
                            <tr>
